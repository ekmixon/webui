...
def apply_acl_with_both_recusrive_and_transverse_set_to_rtacltest1(driver):
    ...
    assert wait_on_element(
        driver,
        5,
        '//tr[contains(.,"rt-acl-test-1")]//mat-icon[text()="more_vert"]',
        'clickable',
    )
...
def verify_that_the_acl_was_set_to_rtacltest2(driver):
    ...
    assert wait_on_element(
        driver,
        5,
        '//div[contains(text(),"rt-acl-test-1")]//button',
        'clickable',
    )
    ...
    assert wait_on_element(
        driver,
        5,
        '//tr[contains(.,"rt-acl-test-2")]//mat-icon[text()="more_vert"]',
        'clickable',
    )
...
def verify_that_the_acl_was_not_set_to_rtacltest3(driver):
    ...
    assert wait_on_element(
        driver,
        5,
        '//tr[contains(.,"rt-acl-test-3")]//mat-icon[text()="more_vert"]',
        'clickable',
    )
...
def verify_the_smb_share_filesystem_has_the_acl_that_was_applied_to_rtacltest1(driver):
    ...
    assert wait_on_element(
        driver,
        5,
        '//tr[contains(.,"rt-test")]//mat-icon[@ix-auto="options__rt-test"]',
        'clickable',
    )
    ...
    assert wait_on_element(
        driver,
        5,
        '//button[@ix-auto="action__rt-test_Edit Filesystem ACL"]',
        'clickable',
    )
